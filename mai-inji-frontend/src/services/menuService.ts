  ...
  getMenu: async (includeSoldOut: boolean = false): Promise<MenuItem[]> => {
    ...
    if (env.softLaunchMode) {
      ...
      const mockItems: MenuItem[] = [
        { id: '1', name: 'Signature Shawarma', description: 'Our famous chicken shawarma, toasted to perfection with creamy garlic sauce and fresh veggies.', price: 2500, price_formatted: '₦2,500', created_at: new Date().toISOString(), category_id: 'c1', is_available: true, image_url: MENU_ITEMS.Shawarma, label: 'Best Seller' },
        { id: '2', name: 'Gourmet Beef Burger', description: 'Double beef patty, melted cheese, caramelized onions, and house secret sauce on a brioche bun.', price: 4500, price_formatted: '₦4,500', created_at: new Date().toISOString(), category_id: 'c1', is_available: true, image_url: MENU_ITEMS.Burger, label: 'Premium' },
        { id: '3', name: 'Hibiscus Zobo (Chilled)', description: 'Refreshing hibiscus punch infused with ginger, cloves, and natural pineapple essence.', price: 1000, price_formatted: '₦1,000', created_at: new Date().toISOString(), category_id: 'c2', is_available: true, image_url: MENU_ITEMS.Zobo, label: 'Cooler' },
        { id: '4', name: 'Creamy Tigernut Milk', description: 'Rich, dairy-free Kunu Aya beverage made from fresh tigernuts and dates.', price: 1500, price_formatted: '₦1,500', created_at: new Date().toISOString(), category_id: 'c2', is_available: true, image_url: MENU_ITEMS.Tigernut, label: 'Traditional' },
        { id: '5', name: 'Yoghurt Parfait', description: 'Creamy Greek-style yoghurt layered with granola, honey, and seasonal fruits.', price: 2500, price_formatted: '₦2,500', created_at: new Date().toISOString(), category_id: 'c3', is_available: true, image_url: MENU_ITEMS.Yoghurt, label: 'Sweet Treat' },
        { id: '6', name: 'Spiced Arabian Tea', description: 'Aromatic milk tea brewed with cardamom, cinnamon, and special Arabian spices.', price: 1200, price_formatted: '₦1,200', created_at: new Date().toISOString(), category_id: 'c2', is_available: true, image_url: MENU_ITEMS["Arabian Tea"], label: 'Classic' },
        { id: '7', name: 'Masa Platter', description: 'Soft fermented rice cakes served hot with spicy Miyan Taushe and beef chunks.', price: 2000, price_formatted: '₦2,000', created_at: new Date().toISOString(), category_id: 'c1', is_available: true, image_url: MENU_ITEMS.Masa, label: 'Traditional' },
        { id: '8', name: 'Beef Suya Skewers', description: 'Authentic coal-grilled beef skewers dusted with spicy Yaji pepper blend.', price: 1500, price_formatted: '₦1,500', created_at: new Date().toISOString(), category_id: 'c1', is_available: true, image_url: MENU_ITEMS.Suya, label: 'Street Favorite' },
        { id: '9', name: 'Boba Milk Tea', description: 'Sweet milk tea features chewy tapioca pearls and brown sugar syrup.', price: 4000, price_formatted: '₦4,000', created_at: new Date().toISOString(), category_id: 'c2', is_available: true, image_url: MENU_ITEMS["Boba Tea"], label: 'Must Try' },
        { id: '10', name: 'Pepperoni Pizza Slice', description: 'Classic cheesy pizza slice topped with premium beef pepperoni.', price: 3000, price_formatted: '₦3,000', created_at: new Date().toISOString(), category_id: 'c1', is_available: true, image_url: MENU_ITEMS.Pizza, label: "Chef's Pick" },
      ];
      return mockItems;
    }
